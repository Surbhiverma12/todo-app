    ...
    <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-6 sm:p-8 max-w-4xl w-full mx-auto border border-gray-100">
      ...
      <div className="mb-8 relative">
        <input
          ...
          className="w-full px-6 py-4 pl-12 bg-gray-50/50 border-2 border-gray-100 rounded-2xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all text-lg placeholder:text-gray-400"
        />
        <svg 
